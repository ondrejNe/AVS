...
void SPI_Init(void) {
    ...
    GPIO_InitStruct.Pin = SPI_PIN_MOSI | SPI_PIN_MISO | SPI_PIN_SCK;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    HAL_GPIO_Init(SPI_PORT, &GPIO_InitStruct);

    SpiHandle.Instance = SPI2;
    SpiHandle.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_16; // Adjust as needed for your clock settings
