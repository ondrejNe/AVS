...
{
  LCD_FRAME_BUFFER,
  LCD_FRAME_BUFFER + (800*480*4),   // ARGB8888 format, which uses 4 bytes per pixel
};
...
//    UTIL_LCD_DisplayStringAt(0, 420, (uint8_t *)"LCDsgsgdsgsDoubleBuffering", CENTER_MODE);
//    HAL_DSI_Refresh(&hlcd_dsi);
//    HAL_DSI_Refresh(&hlcd_dsi);
  /* Infinite loop */
  while (1)
...
//      UTIL_LCD_DisplayStringAt(0, 420, (uint8_t *)"LCD_DSI_right", RIGHT_MODE);
      BSP_LED_Toggle(LED2);
      HAL_Delay(500);
      ...
      HAL_Delay(500);
//      UTIL_LCD_Clear(UTIL_LCD_COLOR_WHITE);
//      UTIL_LCD_DisplayStringAt(0, 420, (uint8_t *)"LCD_DSI_left", LEFT_MODE);
...
//      HAL_DSI_Refresh(&hlcd_dsi);
//
//      /* Wait some time before switching to the next stage */
//      UTIL_LCD_Clear(UTIL_LCD_COLOR_WHITE);
//      UTIL_LCD_DisplayStringAt(0, 420, (uint8_t *)"LCD_DSI_right", RIGHT_MODE);
//      HAL_Delay(5000);
//      UTIL_LCD_Clear(UTIL_LCD_COLOR_WHITE);
...
static void SystemClock_Config(void)
{
  ...
  /* Enable HSE Oscillator and activate PLL with HSE as a source */
